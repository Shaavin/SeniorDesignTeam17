...
namespace AC
{
	...
	public class OptionsFileHandler_SystemFile : iOptionsFileHandler
	{
		...
		{
			return Application.persistentDataPath + Path.DirectorySeparatorChar.ToString () + KickStarter.settingsManager.SavePrefix + "_ProfileData_" + profileID.ToString () + SaveSystem.OptionsFileFormatHandler.GetSaveExtension ();
		}


		protected string GetActiveProfileDataFullFilename ()
		{
			return Application.persistentDataPath + Path.DirectorySeparatorChar.ToString () + KickStarter.settingsManager.SavePrefix + "_ActiveProfileData" + SaveSystem.OptionsFileFormatHandler.GetSaveExtension ();
		}
