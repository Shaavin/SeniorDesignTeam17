	...
	public class PlayerInput : MonoBehaviour
	{
		...
		public void UpdateInput ()
		{
			...
			if (KickStarter.stateHandler && KickStarter.settingsManager)
			{
				...
				{
					KickStarter.runtimeInventory.HoverInstance.InvItem.RunDefaultInteraction ();
					ResetMouseClick ();
					ResetClick ();
					return;
				}
		...
		protected void SetDragState ()
		{
			...
			else if (KickStarter.mainCamera.attachedCamera && KickStarter.mainCamera.attachedCamera.isDragControlled && !KickStarter.stateHandler.AreCamerasDisabled ())
			{
		...
		{
			Vector3 deltaCamera = KickStarter.CameraMainTransform.position - lastCameraPosition;
